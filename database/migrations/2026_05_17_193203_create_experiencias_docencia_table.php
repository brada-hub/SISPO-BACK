...
return new class extends Migration
{
    ...
    {
        Schema::create('experiencias_docencia', function (Blueprint $table) {
            $table->id();
            ...
            $table->text('asignaturas')->nullable();
            $table->string('gestion_periodo')->nullable();
    ...
    {
        Schema::dropIfExists('experiencias_docencia');
    }
};
